...
public class UserBaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + DBschema.TripTable.NAME + "(" +
                // " _id integer primary key autoincrement, " +
                DBschema.TripTable.Cols.UID+ " , " +
                DBschema.TripTable.Cols.STARTST + ", " +
                DBschema.TripTable.Cols.ENDST + ", " +
                DBschema.TripTable.Cols.DEPARTTIME + ", " +
                DBschema.TripTable.Cols.ARRIVALTIME +", " +
                DBschema.TripTable.Cols.TRAVELPRICE +
                ")"
