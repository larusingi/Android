  ...
  private  BeaconManager beaconManager;
   private BeaconRegion region;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curr = (TextView) v.findViewById(R.id.startStLabel);
        dest = (TextView) v.findViewById(R.id.travelExitStLabel);
        finalPr = (TextView) v.findViewById(R.id.finalPriceLabel);
        checkOut = (Button) v.findViewById(R.id.travelStopButton);
        checkOut.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View v) {

                                            String sz = curr.getText().toString().trim();
                                            String ez = dest.getText().toString().trim();
                                            ...
                                            if (finalprice > 0) {
                                                ...
                                                finalPr.setText(finalprice+ " kr paid");
                                                } else {
        ...
        beaconManager.setRangingListener(new BeaconManager.BeaconRangingListener() {
            ...
            public void onBeaconsDiscovered(BeaconRegion beaconRegion, List<Beacon> list) {
                if (!list.isEmpty()) {
                    ...
                    int i = 3;
                    if(list.size()>0){
                        String startST = Integer.toString(list.get(0).getMajor());
                        dest.setText(startST);
                    }
